...
%prep
%setup -q -n Sub-Exporter-0.988
cd %{_builddir}
tar xf %{_sourcedir}/libsub-exporter-perl_0.987-1.debian.tar.xz
cd %{_builddir}/Sub-Exporter-0.988
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Sub-Exporter-0.988/deblicense/
...
cp %{_builddir}/Sub-Exporter-0.988/LICENSE %{buildroot}/usr/share/package-licenses/perl-Sub-Exporter/27e158af651b5a0cac04a11de0e4ab7abe601a0b
...
/usr/share/package-licenses/perl-Sub-Exporter/27e158af651b5a0cac04a11de0e4ab7abe601a0b
