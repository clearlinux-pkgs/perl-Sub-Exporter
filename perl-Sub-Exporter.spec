...
%prep
%setup -q -n Sub-Exporter-0.990
cd %{_builddir}
tar xf %{_sourcedir}/libsub-exporter-perl_0.987-1.debian.tar.xz
cd %{_builddir}/Sub-Exporter-0.990
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Sub-Exporter-0.990/deblicense/
pushd ..
cp -a Sub-Exporter-0.990 buildavx2
popd
